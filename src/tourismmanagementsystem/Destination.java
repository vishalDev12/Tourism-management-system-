...
public class Destination extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text =new String[]{"Jw Marriott Hotel","Mandarin Oriental Hotel","Four Seasons Hotel","Radisson Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blows Hotel","Quick Stop Hotel","Quick Stop Hotel","Happy Mornings Motel","Moss View Hotel"};
        try{
        for(int i=0;i<=9;i++){
    ...
    Destination(){
        ...
        for(int i=0;i<=9;i++){
        image[i]=new ImageIcon(ClassLoader.getSystemResource("tourismmanagementsystem/icons/dest"+(i+1)+".jpg"));
