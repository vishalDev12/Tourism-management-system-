...
public class DeleteCustomer extends JFrame implements ActionListener{
    ...
    DeleteCustomer(String user){
        ...
        b2.setBounds(210,460,100,25);
        b2.addActionListener(this);
        add(b2);
        
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("tourismmanagementsystem/icons/delete.png"));
